...
interface StudyRepository {
    ...
    suspend fun generateFlashCards(noteId: String): NetworkResult<Unit>
    ...
    suspend fun generateQuiz(noteId: String): NetworkResult<Unit>
    ...
    suspend fun generateMindMap(noteId: String): NetworkResult<Unit>
